  ...
  Future<void> submit() async {
    ...
    if (photoBytes != null) {
      photoUrl = await uploadFile(
          photoBytes!, 'student_docs/${widget.studentUid}/photo.jpg');
    }
    if (resultDocBytes != null) {
      resultDocUrl = await uploadFile(
          resultDocBytes!, 'student_docs/${widget.studentUid}/result.pdf');
    }
    ...
    if (context.mounted) {
      ScaffoldMessenger.of(context)
          .showSnackBar(const SnackBar(backgroundColor: Colors.green,content: Text('Details submitted!')));
          ...
          child: ListView(
            children: [
              ...
              TextFormField(
                ...
                validator: (v) =>
                    v == null || v.trim().isEmpty ? 'Enter your class' : null,
              ),
              const SizedBox(height: 16),
                ...
                return Row(
                  ...
                  children: [
                    Expanded(
                      child: TextFormField(
                        key: ValueKey(
                            'subject_name_${i}_${subjects[i]['name']}'),
                ...
                children: [
                  Expanded(
                    child: TextFormField(
                      ...
                      decoration:
                          const InputDecoration(labelText: 'Min Fees *'),
                  ...
                  Expanded(
                    child: TextFormField(
                      ...
                      decoration:
                          const InputDecoration(labelText: 'Max Fees *'),
                      keyboardType: TextInputType.number,
                      validator: (v) =>
                          v == null || v.trim().isEmpty ? 'Required' : null,
                    ),
